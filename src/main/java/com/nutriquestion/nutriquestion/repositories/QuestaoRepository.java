...
//	
	@Query(nativeQuery = true, value = "select * from tb_questao where tb_questao.questionario_id = :idQuest")
	Optional<List<Questao>> findByQestaoQuestionario(@Param("idQuest") Long idQuestionario);
}
